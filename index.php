...
<!-- union section end -->
<!--  full left section -->
<section id="first_scction"><!--  first secton starrt -->
  ...
  <div class="row">
    ...
    <div class="col-md-8">
      <div class="left_content_wrap">
        ...
        <div class="secont_section"> <!--  secont section start-->
        ...
        <a href="" class="full_details text-right">আরো দেখুন <i class="fa fa-angle-double-right" ></i></a><!--  second section end-->
        <div class="third_section"><!--  third section start-->
        ...
        <section class="fifth_wrap">
          ...
          <ul>
            ...
            <li><a href=""><i class="fa fa-hand-o-right" ></i> ঠোর স্বাস্থ্যবিধি প্রতিপালন সাপেক্ষে দোকানপাঠ ও শপিংমল খোলা ...</a></li>
            </ul><!-- forth section start-->
            </section><!-- forth section end-->
